    ...
    switch (action.type) {
        ...
        case ORDER_BY_NAME:
            ...
            const orderName = orderNameCopy.sort( (a, b) => {
                if ( a.name > b.name ) return "Ascendente" === action.payload ? 1 : -1;
                if ( a.name < b.name ) return "Descendente" === action.payload ? 1 : -1;
                return 0;
            } );
            return {
                ...state, 
        ...
        case ORDER_BY_POPULATION:
            ...
            const orderPopulation = orderPopulationCopy.sort( (a, b) => {
                if ( a.population > b.population ) return "Ascendente" === action.payload ? 1 : -1;
                if ( a.population < b.population ) return "Descendente" === action.payload ? 1 : -1;
                return 0
            } );
            return {
                ...state, 
        ...
        case FILTER_BY_ACTIVITIES:
            ...
            const activitiesFiltered = filterByActivities.filter( country => country.tours && country.tours.find( activity => activity.name === action.payload ));
            return {
                ...state,
